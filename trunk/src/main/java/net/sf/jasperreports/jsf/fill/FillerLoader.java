...
public final class FillerLoader {
    ...
    private static final Map<String, Class<FillerFactory>> fillerCacheMap =
    	Util.loadServiceMap(FillerFactory.class);
    ...
    public static Filler getFiller(final FacesContext context,
        ...
        if (dataSource == null) {
            ...
            FillerFactory factory = getFillerFactory(context, dataSource);
