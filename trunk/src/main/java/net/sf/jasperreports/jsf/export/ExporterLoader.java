...
public final class ExporterLoader {
    ...
    private static final Map<String, Class<ExporterFactory>> exporterCacheMap =
    	Util.loadServiceMap(ExporterFactory.class);
    ...
    private static ExporterFactory getExporterFactory(final FacesContext context, final UIReport report)
    throws JRFacesException {
    	final Class<ExporterFactory> exporterFactoryClass = exporterCacheMap.get(report
                .getFormat());
