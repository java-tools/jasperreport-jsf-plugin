...
public class HtmlExporterFactory extends AbstractExporterFactory {

	@Override
	protected Exporter doCreateExporter(final FacesContext context,
			final UIReport report) throws ExporterException {
		return new HtmlExporter((UIComponent) report);
	}
