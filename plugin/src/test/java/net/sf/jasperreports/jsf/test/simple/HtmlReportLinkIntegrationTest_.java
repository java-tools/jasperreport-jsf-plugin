...
import net.sf.jasperreports.jsf.test.ComponentTestBase;

@RunWith(Parameterized.class)
public class HtmlReportLinkIntegrationTest_ extends ComponentTestBase {
    ...
    public HtmlReportLinkIntegrationTest_(final String linkId) {
        this.linkId = linkId;
    }
