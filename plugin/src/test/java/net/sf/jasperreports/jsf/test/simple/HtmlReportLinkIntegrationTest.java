...
import net.sf.jasperreports.jsf.test.framework.ComponentTestBase;

@RunWith(Parameterized.class)
public class HtmlReportLinkIntegrationTest extends ComponentTestBase {
    ...
    public HtmlReportLinkIntegrationTest(final String linkId) {
        this.linkId = linkId;
    }

    @Test
    public void clickOnLink() throws Exception {
        final WebResponse reportView = getReportView();
